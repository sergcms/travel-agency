                ...
                <div class="card-body">
                    <form method="post" action="{{ route('user-create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="travel_agency_id" type="number" class="form-control{{ $errors->has('travel_agency_id') ? ' is-invalid' : '' }}" name="travel_agency_id" value="{{ old('travel_agency_id') }}" autofocus>
                            </div>
                        </div>
