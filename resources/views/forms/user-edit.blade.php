                ...
                <div class="card-body">
                    <form method="post" action="{{ route('user-update', $id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="travel_agency_id" type="number" class="form-control{{ $errors->has('travel_agency_id') ? ' is-invalid' : '' }}" name="travel_agency_id" value="{{ $user->travel_agency_id }}" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="block" id="block" value="1" {{ $user->block == 0 ? '' : 'checked' }}>
