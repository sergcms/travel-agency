                ...
                <div class="card-body">
                    <form method="post" action="{{ route('tour-create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hotel" type="text" class="form-control{{ $errors->has('hotel') ? ' is-invalid' : '' }}" name="hotel" value="{{ old('hotel') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="food" type="text" class="form-control{{ $errors->has('food') ? ' is-invalid' : '' }}" name="food" value="{{ old('food') }}" required autofocus>
